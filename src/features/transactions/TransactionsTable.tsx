                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                        ...
                        ? (
                            ...
                            <tr key={transaction.id} className="bg-white hover:bg-gray-50">
                                ...
                                <td className={`whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500 ${transaction.amount >= 0 ? "text-green-500" : "text-red-500"}`}>
                                    $<span className="font-medium">{Math.abs(transaction.amount)}</span>
                                </td>
